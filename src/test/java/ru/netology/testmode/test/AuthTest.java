...
public class AuthTest {
    ...
    void shouldGetErrorIfNotRegisteredUser() {
        ...
        $("button.button").click();
        $("[data-test-id=error-notification]").shouldHave(
                Condition.exactText("Ошибка Ошибка! Неверно указан логин или пароль")).shouldBe(Condition.visible);
    }
    ...
    void shouldGetErrorIfBlockedUser() {
        ...
        $("button.button").click();
        $("[data-test-id=error-notification]").shouldHave(
                Condition.exactText("Ошибка Ошибка! Пользователь заблокирован")).shouldBe(Condition.visible);
    }
